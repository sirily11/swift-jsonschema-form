...
class JSONSchemaFormObjectTests: XCTestCase {
    ...
    func testSimpleObject() async throws {
        ...
        let ageTextField = try form.inspect().find(viewWithId: "root_age").textField()
    ...
    func testNestedObject() async throws {
        ...
        let nameTextField = try form.inspect().find(viewWithId: "root_person_name").textField()
        let cityTextField = try form.inspect().find(viewWithId: "root_person_address_city").textField()
        let streetTextField = try form.inspect().find(viewWithId: "root_person_address_street").textField()
    ...
    func testObjectWithRequiredProperties() async throws {
        ...
        // Find the fields
        let emailTextField = try form.inspect().find(viewWithId: "root_email").textField()
        let nicknameTextField = try form.inspect().find(viewWithId: "root_nickname").textField()
    ...
    func testObjectPropertyEdit() async throws {
        ...
        let textField = try form.inspect().find(viewWithId: "root_title").textField()
    ...
    func testEmptyObject() async throws {
        ...
        let optionalTextField = try form.inspect().find(viewWithId: "root_optional").textField()
